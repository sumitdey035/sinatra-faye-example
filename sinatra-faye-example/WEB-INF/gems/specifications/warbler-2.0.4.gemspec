...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rubyzip>.freeze, ["< 1.4", "~> 1.0"])
      ...
      s.add_dependency(%q<jruby-rack>.freeze, ["< 1.3", ">= 1.1.1"])
      s.add_dependency(%q<rubyzip>.freeze, ["< 1.4", "~> 1.0"])
